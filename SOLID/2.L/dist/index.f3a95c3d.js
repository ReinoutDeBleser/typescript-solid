...
cart.addProduct(new Product1('Chair', 25, new Discount1("fixed", 10)));
//cart.addProduct(new Product('Chair', 25, new Discount("fixed", -10)));
cart.addProduct(new Product1('Table', 50, new Discount1("variable", 25)));
cart.addProduct(new Product1('Bed', 100, new Discount1("none")));
...
//# sourceMappingURL=index.f3a95c3d.js.map
